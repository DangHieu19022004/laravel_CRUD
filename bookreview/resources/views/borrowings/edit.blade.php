    ...
    <div class="card-body">
        <form method="post" action="{{ route('borrowings.update', $borrowing->{Table::tb2_1}) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="{{ Table::tb2_2 }}" name="{{ Table::tb2_2 }}" value="{{ $borrowing->{ Table::tb2_2} }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="{{ Table::tb2_4 }}" value="{{ $borrowing->{ Table::tb2_4 } }}">
                </div>
            </div>
            <div class="row mb-3">
