...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('borrowings.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <label for="" class="col-sm-2 col-form-label">{{Table::column2}}</label>
                <div class="col-sm-10">
                    <input type="text" name="{{Table::tb2_2}}" class="form-control">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" name="{{Table::tb2_4}}" class="form-control">
                </div>
            </div>
            <div class="row mb-3">
