    ...
    <div class="card-body">
        <form method="post" action="{{ route('borrowings.update', $borrowing->{Table::tb2_1}) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name="{{ Table::tb2_5 }}" value="{{ $borrowing->{ Table::tb2_5 } }}">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label">{{ Table::column6 }}</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" name="{{ Table::tb2_6 }}" value="{{ $borrowing->{ Table::tb2_6 } }}">
                </div>
            </div>
